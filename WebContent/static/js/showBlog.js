$(document).ready(function(){
	...
	BlogManager.getSession(function(blog){
...
//					$("#reply-"+blog.bid).text(blog.author+":"+com[i].reply);
					...
					'<div id="comment-'+blog.bid+'" style="float:left;font-size:15px;">'+com[i].ptext+'</div><a id="yaoreply-'+i+'"  class="huifu">回复</a><span style="float:left;font-size:15px; color:red" id="tishi-huifu-'+i+'"></span><br><div id="zdreply-'+i+'"></div>';
